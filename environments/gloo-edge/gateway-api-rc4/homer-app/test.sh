...
echo "127.0.0.1 argocd.edge.glooplatform.com homer.edge.glooplatform.com httpbin.edge.glooplatform.com bookinfo.edge.glooplatform.com general-chatbot.edge.glooplatform.com language-chatbot.edge.glooplatform.com"
echo 
