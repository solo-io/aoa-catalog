...
$SCRIPT_DIR/tools/wait-for-rollout.sh deployment istio-operator-1-24 gm-iop-1-24 10 ${cluster_context}
...
#./tools/wait-for-rollout.sh deployment istio-eastwestgateway-1-24 istio-eastwest 10 ${cluster_context}