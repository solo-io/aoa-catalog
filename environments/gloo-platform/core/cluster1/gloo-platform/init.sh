...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.7.0-beta0-2024-07-22-main-34b22a4a9c):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.7.0-beta0-2024-07-22-main-34b22a4a9c
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.7.0-beta0-2024-07-22-main-34b22a4a9c
            config:
                exporters:
                    otlp:
