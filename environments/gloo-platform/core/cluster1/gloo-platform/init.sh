...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.6.0-beta3-2024-06-02-main-c6922b81e6):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.6.0-beta3-2024-06-02-main-c6922b81e6
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.6.0-beta3-2024-06-02-main-c6922b81e6
            config:
                exporters:
                    otlp:
