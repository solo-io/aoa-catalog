...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.7.0-beta0-2024-10-16-puertomontt-gg-env-500a30fe59):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.7.0-beta0-2024-10-16-puertomontt-gg-env-500a30fe59
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.7.0-beta0-2024-10-16-puertomontt-gg-env-500a30fe59
            config:
                exporters:
                    otlp:
