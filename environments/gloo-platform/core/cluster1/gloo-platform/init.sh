...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.6.0-beta3-2024-05-29-main-98a6d8de18):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.6.0-beta3-2024-05-29-main-98a6d8de18
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.6.0-beta3-2024-05-29-main-98a6d8de18
            config:
                exporters:
                    otlp:
