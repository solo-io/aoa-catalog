...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.5.3-2024-03-15-v2.5.x-d70ff8de27):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.5.3-2024-03-15-v2.5.x-d70ff8de27
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.5.3-2024-03-15-v2.5.x-d70ff8de27
            config:
                exporters:
                    otlp:
