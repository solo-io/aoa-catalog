...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.7.0-beta0-2024-07-31-ashleywang1-fix-ui-clusters-connected-c2e19cc109):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.7.0-beta0-2024-07-31-ashleywang1-fix-ui-clusters-connected-c2e19cc109
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.7.0-beta0-2024-07-31-ashleywang1-fix-ui-clusters-connected-c2e19cc109
            config:
                exporters:
                    otlp:
