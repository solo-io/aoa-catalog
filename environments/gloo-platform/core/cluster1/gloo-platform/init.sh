...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.6.0-rc2-2024-07-02-otel-bump):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.6.0-rc2-2024-07-02-otel-bump
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.6.0-rc2-2024-07-02-otel-bump
            config:
                exporters:
                    otlp:
