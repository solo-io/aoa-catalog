...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.5.4-2024-03-31-v2.5.x-4f6a729164):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.5.4-2024-03-31-v2.5.x-4f6a729164
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.5.4-2024-03-31-v2.5.x-4f6a729164
            config:
                exporters:
                    otlp:
