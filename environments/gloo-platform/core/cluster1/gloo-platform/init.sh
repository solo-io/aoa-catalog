...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.7.0-beta0-2024-08-25-main-5731e30d80):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.7.0-beta0-2024-08-25-main-5731e30d80
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.7.0-beta0-2024-08-25-main-5731e30d80
            config:
                exporters:
                    otlp:
