...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.6.3-2024-09-07-v2.6.x-685df442d7):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.6.3-2024-09-07-v2.6.x-685df442d7
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.6.3-2024-09-07-v2.6.x-685df442d7
            config:
                exporters:
                    otlp:
