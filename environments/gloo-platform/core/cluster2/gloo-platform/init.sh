...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.6.0-beta3-2024-05-30-main-1d26e8b265):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.6.0-beta3-2024-05-30-main-1d26e8b265
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.6.0-beta3-2024-05-30-main-1d26e8b265
            config:
                exporters:
                    otlp:
