...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.6.3-2024-09-14-v2.6.x-960385efbe):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.6.3-2024-09-14-v2.6.x-960385efbe
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.6.3-2024-09-14-v2.6.x-960385efbe
            config:
                exporters:
                    otlp:
