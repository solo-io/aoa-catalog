...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.7.0-beta1-2024-12-11-main-8512036382):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.7.0-beta1-2024-12-11-main-8512036382
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.7.0-beta1-2024-12-11-main-8512036382
            config:
                exporters:
                    otlp:
