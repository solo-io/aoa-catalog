...
![High Level Architecture](.images/multicluster-podinfo-cluster1-arch-1a.png)
...
```
cat <<EOF | sudo tee -a /etc/hosts
localhost argocd-local.glootest.com cluster1-argocd-local.glootest.com cluster2-argocd-local.glootest.com gmui-local.glootest.com podinfo-local.glootest.com
EOF
```
