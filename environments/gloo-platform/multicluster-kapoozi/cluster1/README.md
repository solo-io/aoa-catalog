...
![High Level Architecture](.images/multicluster-onlineboutique-cluster1-arch-1a.png)
...
${GATEWAY_IP} argocd.kapoozi.com gmui.kapoozi.com shop.kapoozi.com
EOF
```
...
```
cat <<EOF | sudo tee -a /etc/hosts
127.0.0.1 argocd.kapoozi.com gmui.kapoozi.com shop.kapoozi.com
EOF
```
