...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.7.0-beta0-2024-09-17-main-4f36cdd2ce):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.7.0-beta0-2024-09-17-main-4f36cdd2ce
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.7.0-beta0-2024-09-17-main-4f36cdd2ce
            config:
                exporters:
                    otlp:
