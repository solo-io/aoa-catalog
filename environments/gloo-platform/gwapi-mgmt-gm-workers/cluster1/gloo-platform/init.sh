...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.7.0-beta0-2024-10-02-ashleywang1-fix-base-path-helm-value-9763b86b23):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.7.0-beta0-2024-10-02-ashleywang1-fix-base-path-helm-value-9763b86b23
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.7.0-beta0-2024-10-02-ashleywang1-fix-base-path-helm-value-9763b86b23
            config:
                exporters:
                    otlp:
