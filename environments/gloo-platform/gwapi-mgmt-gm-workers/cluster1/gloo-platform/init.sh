...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.6.0-2024-08-21-v2.6.x-a0e35cbfac):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.6.0-2024-08-21-v2.6.x-a0e35cbfac
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.6.0-2024-08-21-v2.6.x-a0e35cbfac
            config:
                exporters:
                    otlp:
