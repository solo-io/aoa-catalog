...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. 2.7.0-beta0-2024-09-26-ashleywang1-fix-base-path-helm-value-2d7859de5f):"
...
spec:
  ...
  source:
    ...
    targetRevision: 2.7.0-beta0-2024-09-26-ashleywang1-fix-base-path-helm-value-2d7859de5f
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: 2.7.0-beta0-2024-09-26-ashleywang1-fix-base-path-helm-value-2d7859de5f
            config:
                exporters:
                    otlp:
