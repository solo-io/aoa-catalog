...
if [[ ${gloo_mesh_version} == "" ]]
  then
    ...
    echo "Please provide the gloo_mesh_version to use (i.e. v2.6.8-2025-01-30-v2.6.x-7283cf42d2):"
...
spec:
  ...
  source:
    ...
    targetRevision: v2.6.8-2025-01-30-v2.6.x-7283cf42d2
  syncPolicy:
    automated:
      prune: true
      selfHeal: true
      ...
      values: |
        ...
        telemetryCollector:
            ...
            image:
              ...
              tag: v2.6.8-2025-01-30-v2.6.x-7283cf42d2
            config:
                exporters:
                    otlp:
