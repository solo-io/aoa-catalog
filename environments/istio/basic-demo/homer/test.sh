...
echo "access the dashboard at https://$(kubectl -n istio-system get service istio-ingressgateway -o jsonpath='{.status.loadBalancer.ingress[0].ip}')"
echo
...
echo "https://github.com/solo-io/aoa-catalog/tree/main/environments/gloo-gateway/single-cluster-onlineboutique#application-description"
echo
echo