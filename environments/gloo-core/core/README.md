...
The `gloo-core/core` environment deploys the core components of a single cluster Gloo Core demo, without any applications deployed. This is a great starting ground to get a barebones demo setup where you can bring your own application example into the mesh.
...
- base:
    - gloo mesh 2.5.0-beta0-2023-09-26-npolshak-codegen-istio-insights-52da0dd4b
