...
The `gloo-core/backstage-bookinfo-httpbin` environment deploys the core components of a single cluster Gloo Core demo, with the bookinfo deployed and exposed by Gloo Gateway
