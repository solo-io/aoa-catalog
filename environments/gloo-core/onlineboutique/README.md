...
The `gloo-core/onlineboutique` environment deploys the core components of a single cluster Gloo Core demo, with the onlineboutique application deployed and exposed by Gloo Gateway
