...
The `gloo-gateway/single-cluster-bookinfo` environment deploys the core components of a single cluster Gloo Platform demo, along with the Bookinfo sample application.
