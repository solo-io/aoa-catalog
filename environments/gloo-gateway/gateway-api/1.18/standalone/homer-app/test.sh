...
echo "127.0.0.1 ai-gateway.glootest.com argocd.glootest.com bookinfo.glootest.com general-chatbot.glootest.com homer.glootest.com httpbin.glootest.com language-chatbot.glootest.com"
echo 
