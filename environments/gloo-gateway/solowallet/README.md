...
- solowallet at `https://solowallet.glootest.com/get`
...
${GATEWAY_IP} argocd.glootest.com gmui.glootest.com solowallet.glootest.com
EOF
```
...
```
cat <<EOF | sudo tee -a /etc/hosts
127.0.0.1 argocd.glootest.com gmui.glootest.com solowallet.glootest.com
EOF
```
