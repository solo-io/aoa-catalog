...
The `gloo-gateway/portal` environment deploys the core components of a single cluster Gloo Platform demo with integrated Portal features enabled and httpbin, petstore, and tracks APIs.

![High Level Architecture](.images/portal-arch-1a.png)
...
- Httpbin API at `https://httpbin-local.glootest.com`
- Petstore API at `https://petstore-local.glootest.com`
- Tracks API at `https://tracks-local.glootest.com`
...
${GATEWAY_IP} argocd-local.glootest.com gmui-local.glootest.com httpbin-local.glootest.com petstore-local.glootest.com tracks-local.glootest.com solo-dev-portal.glootest.com
EOF
```
...
```
cat <<EOF | sudo tee -a /etc/hosts
127.0.0.1 argocd-local.glootest.com gmui-local.glootest.com httpbin-local.glootest.com petstore-local.glootest.com tracks-local.glootest.com solo-dev-portal.glootest.com
EOF
```
