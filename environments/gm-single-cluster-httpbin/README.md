...
The `gm-single-cluster-httpbin` environment deploys the core components of a single cluster Gloo Platform demo, along with the httpbin sample application.
