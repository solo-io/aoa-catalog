...
echo "cat <<EOF | sudo tee -a /etc/hosts"
echo "localhost argocd-local.glootest.com api-local.glootest.com portal-local.glootest.com"
echo "EOF"
echo
echo "access argocd at https://argocd-local.glootest.com/argo"
echo "access the petstore ecommerce portal application at: https://portal-local.glootest.com"
echo
