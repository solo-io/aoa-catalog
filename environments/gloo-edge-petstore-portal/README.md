...
The `gloo-edge-petstore-portal` environment deploys a Gloo Edge, Gloo Portal, and Petstore Portal that closely follows the setup of the [Solo Portal Workshop](https://github.com/solo-io/workshops/blob/master/gloo-portal/README.md)
...
- Wave 3 - Deploys Portal Applications
    - petstore-v1
    - petstore-v2
- Wave 3 - Configures Petstore Portal CRDs
...
```
cat <<EOF | sudo tee -a /etc/hosts
localhost argocd-local.glootest.com api-local.glootest.com portal-local.glootest.com
EOF
```
